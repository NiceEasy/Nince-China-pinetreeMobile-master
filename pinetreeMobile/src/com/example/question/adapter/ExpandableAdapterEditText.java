...
public class ExpandableAdapterEditText extends BaseExpandableListAdapter {
	...
	public ExpandableAdapterEditText(Context context, String[] groups, String[][] children) {
	...
	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
		View view = LayoutInflater.from(this.context).inflate(R.layout.activity_sf_mental_state_assessment_part0, null);
		return view;
	}
